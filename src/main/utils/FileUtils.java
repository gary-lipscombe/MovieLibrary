...
public class FileUtils {
    ...
    private static final String INVALID_LOWERCASE_REGEX = "xvid|dvdrip|brrip|axxo|yify|dvdscr|x264|bluray|720p|1080p|r5|ac3" +
            ...
            "|fxg|evo|hdtv|biz|readnfo|wbz|pa|anarchy|720|jyk|3lton|extended|cocain|hd|r33m|bida|grimmo|ozlem|26k";

    private static final String INVALID_CASE_SENSE_REGEX = "NEW|INSPiRAL|RETAIL|NYDIC|FiRE";
